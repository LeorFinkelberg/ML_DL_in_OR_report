...
\begin{align*}
B_p &:= \dfrac{ \tau_{\text{presolve}} + \tau_{\text{relax}} }{ \tau' } \cdot \exp \Big[2 - \bigg(\dfrac{ \#zero\_ints_{\text{relax}} }{ \#ints_{\text{after} } } + \dfrac{ \gamma_{\text{before}} }{ \gamma_{\text{after}} }\Big) \bigg] \cdot \dfrac{ \#conss_{\text{after}} }{ \#conss_{\text{before}} },
\end{align*}
где
